...
const productImagePath = (fileName: string) => `${import.meta.env.BASE_URL}images/products/${fileName}`;
...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: productImagePath('dune-cosmetic-organizer.jpg'),
    imageAlt: 'Dune Cosmetic Organizer styled with skincare bottles and a brush on a neutral vanity surface.',
    gallery: [productImagePath('dune-cosmetic-organizer.jpg')],
    featured: true,
  },
  {
    ...
    image: productImagePath('arc-controller-stand.jpg'),
    imageAlt: 'Arc Controller Stand displaying a game controller in a warm minimal media setup.',
    gallery: [productImagePath('arc-controller-stand.jpg')],
  },
  {
    ...
    materials: ['Matte PLA', 'Optional felt base'],
    image: productImagePath('elevate-headset-stand.jpg'),
    imageAlt: 'Elevate Headset Stand holding a headset on a calm neutral desk surface.',
    gallery: [productImagePath('elevate-headset-stand.jpg')],
  },
  {
    ...
    materials: ['Matte PLA'],
    image: productImagePath('wave-catch-all-dish.jpg'),
    imageAlt: 'Wave Catch-All Dish holding jewelry and keys on a warm bedside-style surface.',
    gallery: [productImagePath('wave-catch-all-dish.jpg')],
  },
  {
